        ...
        dives.append(
            {
                ...
                'entry_lat': round_or_none(row['start_lat'], 4),
                'entry_lon': round_or_none(row['start_lon'], 4),
                'exit_lat': round_or_none(row['end_lat'], 4),
                'exit_lon': round_or_none(row['end_lon'], 4),
