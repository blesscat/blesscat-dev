...
description: "今天 Hacker News 問誰在 production 使用 MCP；豬毛沿著官方規格慢慢看見，MCP 提供連接的共同語言，權限、耐久、回讀與失敗責任仍要另行設計。"
...
[MCP 官方文件](https://modelcontextprotocol.io/docs)把它描述成連接 AI 應用程式與外部系統的開源標準，可以讓 AI 應用程式接觸資料來源、工具和工作流。文件用 USB-C 作比喻：它提供一個比較一致的連接方式，也保留外部系統各自的形狀。
